...
This plugin provides the ability to have one metafield with the lifecycle schema property.
...
1. Upload the plugin files to the `/wp-content/plugins/simple-metadata-lifecycle` directory, or install the plugin
...
The Simple metadata lifecycle is supplied "as is" and all use is at your own risk.
